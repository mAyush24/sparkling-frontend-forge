        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center hover:shadow-md transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription>
                  Custom web applications and enterprise solutions built with modern technologies.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription>
                  Cloud migration, infrastructure management, and scalable cloud-native applications.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow duration-300">
              ...
              <CardContent>
                <CardDescription>
                  Cybersecurity solutions, penetration testing, and security audits for your business.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We combine technical expertise with business understanding to deliver solutions that make a real impact.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Over 50+ successful projects delivered across various industries with 99% client satisfaction.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Goal-Oriented Approach</h3>
                <p className="text-muted-foreground">We align our solutions with your business objectives to ensure maximum ROI and value creation.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">We leverage cutting-edge technologies and methodologies to build future-ready solutions.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Our team of experienced developers, designers, and consultants bring diverse expertise.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Rigorous testing and quality control processes ensure reliable and robust solutions.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Ongoing support and maintenance to ensure your solutions continue to perform optimally.</p>
              </div>
            </div>
          </div>
        </div>
