...
export const Career = () => {
  const jobOpenings = [
    ...
    },
    {
      ...
      location: "On-site",
      type: "Full-time",
      description: "Develop robust server-side applications and APIs using Node.js, Python, and cloud technologies."
    },
    {
      ...
      location: "Remote",
      type: "Full-time", 
      description: "Create intuitive and beautiful user experiences for our digital products and client solutions."
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Build your career with TaskNova Solutions. We're looking for passionate individuals 
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-muted-foreground">Continuous learning and career advancement in a dynamic environment.</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-muted-foreground">Work on cutting-edge projects with the latest technologies and methodologies.</p>
              </div>
            </div>
          </div>
